...
We start by introducing the circuit with which we are going to work. Figure \ref{fig:output stage figure} shows the drawn circuit.

\begin{figure}[h!]
\centering
\includegraphics[width=0.5\linewidth{output_stage.pdf}
\caption{Output Stage Circuit}
\label{fig:output stage figure}
\end{figure}
...
\label{fig:output stage figure OP}
\end{figure}
