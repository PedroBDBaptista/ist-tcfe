...
Bellow, we ilustrate the stipulated current directions for all meshes and components, in figure \ref{figmesh}, and present the derived equation system in matrix form.
...
Bellow, we ilustrate the stipulated voltage directions for all branches, in figure \ref{fig:node}, and present the derived equation system in matrix form. For a practical purpose, we expressed the resistencies as their equivelent conductances, as related by eq.\ref{eq:G}.
